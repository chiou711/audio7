 ...
 * {@link ImageCache#getInstance(FragmentManager, ImageCacheParams)} to get
 * an instance of this class, although usually a cache should be added directly to an
 * {@link ImageWorker} by calling
