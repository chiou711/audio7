...
import com.cw.audio7.util.image.ImageWorker;

import androidx.fragment.app.Fragment;

/**
 * This fragment will populate the children of the ViewPager from { com.example.android.displayingbitmaps.ui.ImageDetailActivity}.
 */
public class ImageDetailFragment extends Fragment implements ImageWorker.OnImageLoadedListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (activity instanceof com.cw.audio7.note.ImageDetailActivity) {
            ImageFetcher mImageFetcher = ((com.cw.audio7.note.ImageDetailActivity) getActivity()).getImageFetcher();
